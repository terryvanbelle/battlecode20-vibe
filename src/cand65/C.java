...
public final class C {
    ...
    public static final int RAID_DRONES_MAX = 24;     // drones built in all, from RAID_BUILD_FROM
    public static final int RAID_BUILD_FROM = 900;
    public static final int RAID_FROM = 1400;         // the swarm gathers from this round
    public static final int RAID_MIN = 10;            // and charges with this many in sight of the rally point
