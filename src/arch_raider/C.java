...
public final class C {
    ...
    public static final int DRONES_MAX = 30;          // arch_swarm: the field's 11-32 drone swarms           // Iteration 2: drones fly over the flood and count at the tiebreak
    public static final int DRONE_RESERVE = 100;      // the center keeps this much soup back
    // arch_swarm: the burial swarm the field mounts at r1500-2100 (blocks 8-9): gather, charge together, lift seats
    public static final int RAID_ROUND = 1000;   // arch_raider: the raid comes soon after the candidate's HOME_ROUND
    public static final int RAID_SIZE = 8;
    public static final int RAID_RALLY = 7;
    public static final int RAID_LATEST = 1500;
