...
public final class C {
    ...
    public static final int VAPORATOR_BANK = 500;     // a builder buys a vaporator when the bank exceeds this; Iteration 84: 650 -> 500 (the vaporator census: 0.1-0.4 a game at 650)
