...
public final class C {
    ...
    public static final int DRONES_MAX = 20;          // Iteration 2: drones fly over the flood and count at the tiebreak; Iteration 81: 8 -> 20 (the shield's 16 and spares)
    // Iteration 81 (the drone shield; g_iter12's losses read 2026-09-26): ronniesong0809's drones lift our ring landscapers and drop
    // its own onto the ring to bury the HQ (all five losses end at r1566-1572); winkelmantanner and mvpatel2000 lift the whole wall
    // (NoU: our wall led 1,080 to 868 at r1500 and froze when its 14 landscapers were lifted). A pickup or a drop needs the drone
    // ADJACENT (r2 3) and drones cannot lift drones, so our drones on every Chebyshev-2 tile seal the ring: nothing can be lifted
    ...
    public static final int SHIELD_FC_ROUND = 400;    // the first center once the school stands and this round has come (stage 4: 300 -> 400 -- a center
                                                      // born before r350 is the rush center and buys three drones at cost: 600 soup from the helpers)
    public static final int SHIELD_FC_BANK = 450;     // ... and the bank holds this
