...
public strictfp class Landscaper extends Robot {
    ...
    /** Iteration 40: does circle tile n touch a ring tile that is exposed, on the map and not held by one of our landscapers? */
    ...
    private void wall(MapLocation home) throws GameActionException {
        ...
        for (int i = 8; --i >= 0;) {
            ...
            if (round >= C.WALKWAY_FROM && round < C.SEATS_BY && touchesUnseatedRing(n, home)) continue;   // Iteration 40: past WALKWAY_FROM a circle tile beside a ring tile still unseated is its walkway (Climb); before it every tile is unseated and 38 paid 6%
