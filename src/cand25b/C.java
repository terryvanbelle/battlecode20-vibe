...
public final class C {
    ...
    public static final int MINERS_EARLY = 8;         // Iteration 25b: all eight miners before the ring closes (seats-first makes early seating unnecessary; a closed ring cannot spawn)
