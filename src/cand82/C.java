...
public final class C {
    ...
    // Iteration 82 (rzhan11's burst, read 2026-09-26: 13 of our 20 losses before r400 in 240 band games): four miners, then
    // nothing -- 450-780 banked by r80-90 -- then its school beside our HQ and 0 -> 6 landscapers in 20 rounds, our HQ
    // buried 0 -> 47-50 in ~30. Ours trickled (miners to 8, a refinery, a landscaper per 150): we lost races we were in
    // (their HQ at 47 and 26 when ours died). The rusher waits beside the enemy HQ for the burst's bank; the HQ and the
    // builder hold their soup until the school is planted.
    public static final int RUSH_BURST_BANK = 750;     // plant when the bank holds the school and four landscapers
    public static final int RUSH_BURST_LATEST = 120;   // ... or from this round with RUSH_BURST_MIN
    public static final int RUSH_BURST_MIN = 300;
    public static final int RUSH_HOLD_UNTIL = 150;     // the HQ's extra miners and the builder wait until the plant, or this round
    public static final int RUSH_BURST_SPEND = 20;     // ... and this many rounds after the plant (the school's first 10 are its birth cooldown)
