...
public strictfp class Miner extends Robot {
    ...
    @Override protected void init() throws GameActionException {
        ...
        builder = birth == 3 && MapState.home != null;   // Iteration 67: the second miner builds
        ...
        rusher = birth == 2 && MapState.home != null;   // Iteration 67: the FIRST miner rushes, as poortho's does (at our HQ by r45; ours planted at r49 as the second)
