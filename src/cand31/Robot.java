    ...
    protected void readBlock() throws GameActionException {
        ...
        for (int i = block.length; --i >= 0;) {
            ...
            switch (m[0]) {
                ...
                case Comms.GUN_SITES: MapState.guns[0] = m[1] < 0 ? null : new MapLocation(m[1], m[2]); MapState.guns[1] = m[3] < 0 ? null : new MapLocation(m[3], m[4]); MapState.gunRaised[0] = (m[5] & 1) != 0; MapState.gunRaised[1] = (m[5] & 2) != 0; MapState.gunBuilt[0] = (m[5] & 4) != 0; MapState.gunBuilt[1] = (m[5] & 8) != 0; MapState.gunManned[0] = (m[5] & 16) != 0; MapState.gunManned[1] = (m[5] & 32) != 0; break;
                default: break;
            }
        }
    }
