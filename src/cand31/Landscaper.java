...
public strictfp class Landscaper extends Robot {
    ...
    private void turn2() throws GameActionException {
        ...
        if (helper && round < 700 && round % 15 == id % 15 && pickGun(home)) { helper = false; post = null; gunner = true; Debug.log("@gunner site=" + gunSite + " stand=" + gunStandTile); }   // Iteration 31: a site nobody took
