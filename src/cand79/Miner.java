...
public strictfp class Miner extends Robot {
    ...
    private boolean build() throws GameActionException {
        ...
        // Iteration 79: four net guns from r700, ahead of the vaporators -- the raid window (r1300-2000) is g_iter12's largest
        // loss class (50 of 129; ronniesong0809 brings 160 drones, EmaPajic 136); the guns came after six vaporators, i.e. rarely
        else if (builtSchool > 0 && round >= 700 && builtNet < 4 && soup >= RobotType.NET_GUN.cost + 100) want = RobotType.NET_GUN;
