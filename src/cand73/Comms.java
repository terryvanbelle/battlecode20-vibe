...
public final strictfp class Comms {
    ...
    public static final int SYMMETRY = 5;
    public static final int RUSH_ON = 6;       // Iteration 73: payload: our forward school is spawning (the home school yields the bank)      // payload: surviving hypothesis bits
