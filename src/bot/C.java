...
public final class C {
    ...
    public static final int MINERS_EARLY = 8;   /* plateau stage 3: the economy */         // miners the HQ builds before anything else is affordable
    public static final int MINERS_MAX = 16;   /* plateau stage 3: the economy */           // never more live miners than this (each costs a wall-ring build slot)
    public static final int MINERS_TOTAL = 30;   /* plateau stage 3: the economy */         // hard cap on miners ever built by the HQ
    public static final int MINER_REPLENISH = 20;   /* plateau stage 3: the economy */     // rounds between replacement miners after MINERS_MAX
    public static final int MINER_SOUP_RESERVE = 250;   /* plateau stage 3: the economy */ // after MINERS_EARLY the HQ builds a miner only above this bank
    ...
    public static final int VAPORATOR_BANK = 400;   /* plateau stage 3: the economy */     // a builder buys a vaporator when the bank exceeds this
    public static final int FC_EARLY_BANK = 350;      // Iteration 2: the fulfillment center comes right after the school, at this bank
    public static final int VAPORATORS_MAX = 8;   /* plateau stage 3: the economy */
    ...
    public static final int DRONES_MAX = 20;   /* plateau stage 3: the economy */           // Iteration 2: drones fly over the flood and count at the tiebreak
