...
public final class C {
    ...
    public static final int DRONES_MAX = 60;          // Iteration 6: the sealed economy has nothing else to buy after the flood           // Iteration 2: drones fly over the flood and count at the tiebreak
