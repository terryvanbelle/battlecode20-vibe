...
public strictfp class Landscaper extends Robot {
    ...
    private void turn2() throws GameActionException {
        ...
        if (killSpawner(home)) return;   // Iteration 64
        if (!attacker && !helper) {
    ...
    /** Iteration 64 (the defence against our own rush, cand63; Iteration 53's form): an enemy design school or fulfillment center within 3 of our HQ is buried before anything else
