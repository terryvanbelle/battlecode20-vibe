...
public strictfp class Drone extends Robot {
    ...
    @Override protected void turn() throws GameActionException {
        ...
        if (raidTime) {
            ...
            // scout first: an unconfirmed guess is looked at from just outside gun range (sense r2 24 > shoot r2 15); sense() then prunes or sights it
            ...
            raiding = near + 1 >= C.RAID_SIZE || follow;   // charge with the wave, or after it (a drone at the edge of the cluster sees fewer)
