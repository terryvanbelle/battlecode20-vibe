...
public strictfp class HQ extends Robot {
    ...
    @Override protected void turn() throws GameActionException {
        ...
        if (!postedLoc && round >= 2) postedLoc = post(Comms.make(Comms.HQ_LOC, round, us, loc.x, loc.y));
        else if (!postedOrigin && MapState.originKnown()) postedOrigin = post(Comms.make(Comms.MAP_ORIGIN, round, us, MapState.minX, MapState.minY));
