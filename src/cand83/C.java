...
public final class C {
    ...
    // Iteration 83 (the vaporator census, 2026-09-26: g_iter12 builds 0.1-0.4 vaporators a game -- 2-16 of ~100 games have
    // one -- while its bank idles at 485-776 by r900-1200 on the maps with natural high ground; mapdata.csv: on 19 of 52
    // maps four tiles at 12+ stand within Chebyshev 3-6 of the HQ until r1800-3000). Vaporators on that ground outlive
    // the flood: +2 a round each, forever.
    public static final int HIGH_VAP_ELEV = 12;       // a natural tile this high stays dry until ~r1850
    public static final int HIGH_VAP_BANK = 500;
    public static final int HIGH_VAP_FROM = 200;      // after the school and the first seats
    public static final int HIGH_VAP_MAX = 20;
