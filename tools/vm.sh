...
#   ~/jdk/jdk8u504-b01, ~/projects/vibe/2020 (this repo: src tools test engine),
#   ~/projects/vibe/bc20-benchmarks/{_classes,manifest.tsv}
VM=battlecode-dev; ZONE=us-west1-b; PROJECT=tvanbelle-vibecode
REMOTE_REPO='projects/vibe/2020'
...
VM_IP_CACHE="${TMPDIR:-/tmp}/.bc20-vm-ip-$VM"
