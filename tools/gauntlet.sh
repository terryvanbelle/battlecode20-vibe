...
# ~/projects/vibe/bc20-benchmarks/manifest.tsv (owner.package). The opponent's
...
# rounds,bot_result,reason), summary.txt, maps.txt, losses/*.bc20, and every
...
game () {  # opp map side
  ...
  local REPLAY="$OUT/replays/${OPP}__${MAP}__bot${SIDE}.bc20"
