...
199 games, 107 wins. Noise floor about 0.14; a correlation inside that band is not evidence.
...
| r300 | - | mines (us-them) ~avg | +0.46 | +0.29 | +0.26 | +0.32 | +0.38 | +0.43 | +0.44 |
| r300 | - | spawned (us-them) | +0.60 | +0.14 | +0.13 | +0.35 | +0.44 | +0.49 | +0.56 |
| r350 | - | robots (us-them) ~avg | +0.59 | +0.14 | +0.14 | +0.27 | +0.37 | +0.49 | +0.57 |
| r350 | - | units (us-them) | +0.56 | +0.24 | +0.14 | +0.26 | +0.36 | +0.46 | +0.53 |
| r400 | - | spawned (us-them) ~avg | +0.59 | +0.13 | +0.10 | +0.22 | +0.32 | +0.45 | +0.54 |
...
| r750 | - | moves (us-them) | +0.42 | +0.09 | +0.16 | +0.17 | +0.18 | +0.26 | +0.36 |
| r800 | - | dirtDeps (us-them) ~avg | +0.48 | +0.10 | +0.04 | +0.09 | +0.15 | +0.23 | +0.35 |
| r800 | - | miners (us-them) | +0.31 | +0.18 | +0.15 | +0.24 | +0.25 | +0.26 | +0.31 |
| r900 | - | moves (us-them) ~avg | +0.37 | +0.06 | +0.16 | +0.19 | +0.19 | +0.23 | +0.31 |
| r900 | - | netguns (us-them) | +0.38 | . | -0.08 | -0.06 | +0.03 | +0.25 | +0.31 |
| r950 | - | miners (us-them) ~avg | +0.32 | +0.17 | +0.16 | +0.24 | +0.26 | +0.27 | +0.30 |
| r1050 | - | drones (us-them) | +0.35 | +0.12 | +0.08 | +0.19 | +0.19 | +0.14 | +0.24 |
| - | r900 | aba (us-them) [inverted] | -0.35 | +0.11 | +0.09 | +0.08 | -0.02 | -0.17 | -0.31 |
...
| - | - | died (us-them) [inverted] | +0.23 | +0.15 | +0.18 | +0.11 | +0.20 | +0.11 | +0.07 |
...
| - | - | pickups (us-them) ~avg | +0.21 | +0.07 | +0.12 | +0.16 | +0.19 | +0.18 | +0.21 |
