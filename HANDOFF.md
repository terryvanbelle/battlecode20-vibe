...
- **Incumbent: `src/g_iter12`** (g_iter11 + our own poortho-style rush, Iteration 63; gate 63 ACCEPT 60-34 in the
  paired mirror). **Submitted: 240 games, 111-129, 1823 +- 46, rank 13 of 86** (+79 on g_iter11; 53 wins before r1300 vs 18). Gate 65 (`src/cand65` = g_iter12 + the late drone raid): 5-0, provisional. **Running: `arm65-a/-b`** (96 band games as `us:cand65`). g_iter11: 240 games, 1751 +- 47, rank 13.
