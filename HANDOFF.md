...
- **Incumbent: `src/g_iter10`** (g_iter9 + Iteration 50, the frozen-miner fix; accepted 2026-09-25 evening, its
  submission blocks running). Previous submission g_iter9: 1723 +- 48, rank 19 of 83 after 240 games. Nothing is gated. The ladder rows `cand43b`, `cand49b`, `cand47d` are explained in
